<template>
  ...
  <div class="content">
    ...
    <el-row :gutter="10" class="el-row01">
      <el-col :xs="1" :sm="3" :md="4" :lg="3" :xl="3" class="adapt"
        ><div class="grid-content adapt"></div
      ></el-col>
      <el-col :xs="4" :sm="6" :md="8" :lg="10" :xl="13" class="personalLeft">
        <div class="grid-content">
          ...
          <div class="grid-content-MVdec">
            ...
            <div class="promulgator">
              <span>发布：{{ mvAuthor }}</span>
              <span>时长：{{ duration | filtrationTime() }}</span>
            ...
            <div class="btnbox">
              ...
              <div class="btn">
                <span class="el-icon-star-on">{{ collectCount }}</span>
              </div>
              <div class="btn">
            ...
            <div class="Commentnumber">
              ...
              <div class="areaText">
                <img class="areaTextimg"  v-lazy="avatar" alt="" />
                  <el-input
                    type="textarea"
                    placeholder="请输入内容"
                    v-model="textarea"
                  ...
                  <div class="sendcomment" @click="setComment()">评论</div>
                <h3>精彩评论</h3>
                <ul>
                  <li
                    class="sendcommentLi"
...
<script>
import { filtrationTime, GetCommonTime } from '../utils/SongTime.js'
export default {
  name: 'MVdetails',
  inject: ['reload'],
  data () {
    return {
      ...
      mvAuthor: '',
      // 用户名字、头像
      usernopy: this.$store.state.userdata.nickname,
      avatar: this.$store.state.userdata.avatarUrls,
      // 输入框内容
      textarea: '快来发表评论吧~',
  ...
  methods: {
    ...
    async getMVdetails () {
      ...
      // MV作者
      this.mvAuthor = result.data.data.artistName
      // 收藏
      this.collectCount = result.data.data.subCount
      // 评论数
